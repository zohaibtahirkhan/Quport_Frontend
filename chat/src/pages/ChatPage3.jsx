...
const ChatPage3 = () => {
  ...
  const [messages, setMessages] = useState(() => {
    const storedMessages = localStorage.getItem("chatMessagesSoccer");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("chatMessagesSoccer", JSON.stringify(messages));
  }, [messages]);
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <div className="bg-green-600 text-white p-4 flex items-center justify-between">
        <h1 className="text-lg font-semibold">SOCCER AI</h1>
        <button
          onClick={clearChat}
