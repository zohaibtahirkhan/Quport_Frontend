...
const RealTokenPage = () => {
  const [messages, setMessages] = useState(() => {
    const storedMessages = localStorage.getItem("RealTokenMessages");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("RealTokenMessages", JSON.stringify(messages));
  }, [messages]);
  ...
  const clearChat = () => {
    setMessages([]);
    localStorage.removeItem("RealTokenMessages");
  };
