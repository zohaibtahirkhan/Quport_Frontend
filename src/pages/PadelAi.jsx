...
const PadelaiPage = () => {
  const [messages, setMessages] = useState(() => {
    const storedMessages = localStorage.getItem("padelMessages");
  ...
  useEffect(() => {
    localStorage.setItem("padelMessages", JSON.stringify(messages));
  }, [messages]);
  ...
  const clearChat = () => {
    setMessages([]);
    localStorage.removeItem("padelMessages");
  };
